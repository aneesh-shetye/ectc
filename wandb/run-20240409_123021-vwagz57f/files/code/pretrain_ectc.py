...
def pretrain(gpu, args): 
    ...
    if args.optimizer == 'adam': 
        optimizer = torch.optim.Adam(pretrainer.parameters(), lr=args.learning_rate).cuda(gpu)
    else: 
        optimizer = torch.optim.SGD( pretrainer.parameters(), lr=args.learning_rate).cuda(gpu) 
